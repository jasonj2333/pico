...
#from ssd1306 import SSD1306_I2C as display_driver
from sh1106 import SH1106_I2C as display_driver
import framebuf
...
if display:
    oled = display_driver(WIDTH, HEIGHT, i2c)
    if getattr(oled, 'rotate', None):
        oled.rotate()
